                                ...
                                <?php $index = 1; foreach ($member as $row): ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-danger" onclick="return confirm('apakah anda yakin ingin menghapus?')" href="<?php echo base_url('member/hapus/'). $row['id_member'] ?>"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach ?>
                            </tbody>
